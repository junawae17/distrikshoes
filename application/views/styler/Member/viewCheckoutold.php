    ...
    <div class="col-md-12">
      <div class="section-area section-default">
        ...
        <table class="table table-striped table-bordered datatables hidden-xs ">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align:right;"><?=currency($items['subtotal']); ?></td>
                <input type="hidden" name="nama_size[]" value="<?=$items['nama_size'] ?>" class="service">
                <input type="hidden" name="id_size[]" value="<?=$items['size_id'] ?>" class="service">
                <input type="hidden" name="qty[]" value="<?=$items['qty'] ?>" class="service">
            </tr>
            <?php $no++; endforeach; ?>
          </tbody>
          <tfoot>
         ...
         <table class="table table-striped table-bordered datatables hidden-md hidden-lg ">
          <thead>
            <tr>
            <!--   <th>No</th> -->
              <th>Nama Produk</th>
        ...
        <table class="table tbl_hidden" style="display: none;">
          <tbody>
           <tr>
            ...
            <tr>
              <td><span class="alamat2"><?='Alamat : '.$akun['address']?></span></td>
            </tr>
            <tr>
        ...
        <table class="table tbl_hidden" style="display: none;">
          <tbody>
           <tr>
            ...
            <tr>
              <td><span class="nm_pengirimmm"><?=$akun['fullname']?></span></td>
            </tr>
            <tr>
              <td><span class="no_hp_pengirimmm"><?=$akun['email'].' , Telp. '.$akun['phone']?></span></td>
            </tr>
            <tr>
              <td><span class="almt_pengirimmm"><?=$akun['address_name']?> <?=$akun['address']?></span></td>
            </tr>
          ...
          <tfoot >
            ...
            <tr>
                    ...
                    <td style="text-align:right;">
                      ...
                      <input type="hidden" id="kurir" class="kurir" value="Cod">
                      <input type="hidden" id="service" class="service" value="cod">
                      <input type="hidden" id="cost" class="cost" value="0">
                      <input type="hidden" id="total_price" value="<?=$this->cart->total(); ?>">
                      <input type="hidden" id="payment" value="<?=$this->cart->total(); ?>" class="payment">
                      <input type="hidden" id="weight" class="weight" value="<?=array_sum($berat)?>">
                      <input type="hidden" id="nama_tujuan" class="nama_tujuan" value="<?=$akun['fullname']?>">
                      <input type="hidden" id="rtt" class="rt" value=""> 
                      <input type="hidden" id="rww" class="rw" value="">
                      <input type="hidden" id="kde_pos" class="kode_pos" value="">
                      <input type="hidden" id="no_hpp" class="no_hpp" value="">
                      <input type="hidden" id="nama_kota" class="" value="">
                      <input type="hidden" id="nama_prov" class="" value="">
                      <input type="hidden" id="nm_pengirimm" class="kode_pos" value="<?=$akun['fullname']?>">
                      <input type="hidden" id="no_hp_pengirimm" class="no_hpp" value="<?=$akun['phone']?>">
                      <input type="hidden" id="almt_pengirimm" class="" value="<?=$akun['address_name']?>">
                      <input type="hidden" id="mail_pengirimm" class="" value="">
                    </td>
            </tr>
          </tfoot>
        </table>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row form-contact ui-form">
              <div class="col-md-12 col-xs-12">
                <div class="col-md-12 col-xs-12">
                  <input class="form-control" name="nama_pengirim" id="nm_pne" type="text" placeholder="Nama Pengirim" required >
                </div>
              </div>
              <div class="col-md-12 col-xs-12">
                <div class="col-md-12 col-xs-12">
