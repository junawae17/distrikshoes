<div class="container">
  <div class="row">
    ...
    <div style="max-width:600px">
        <table style="border-spacing:0;font-family:sans-serif;color:#333333;Margin:0 auto;width:100%;max-width:600px; border: 1px solid #BFBFBF; box-shadow: 3px 5px 3px #aaa;" align="center" class="">
            <tbody>
                <tr>
