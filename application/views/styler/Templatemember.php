    ...
    <header class="header">
      ...
      <div class="container">
        <div class="header-inner">
          <div class="row">
            <div class="col-sm-3 col-xs-12"> <a href="<?=base_url()?>Beranda" class="logo"> <img class="logo__img" src="<?=base_url().'assets/images/'.$info['logo_app'];?>" width="20%" alt="Logo"> </a> </div>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="copyright text-center">
                <p onmouseover="tampil()"> <a href="<?=base_url()?>"><strong><?=$info['name_app']?></strong></a> <?=date('Y')?></p>
...
s1.async=true;
s1.src='https://embed.tawk.to/5f28d0172da87279037e3bb3/default';
s1.charset='UTF-8';
