...
INSERT INTO `menus__` (`id_menu`, `nama_menu`, `sub_menu`, `icon_menu`, `link_menu`, `is_active`, `posisi_menu`) VALUES
(1, 'Beranda', 0, 'menu-icon fa fa-home faa-tada', 'Admin/Beranda', 1, 1),
(2, 'Mater Toko', 0, 'menu-icon fa fa-list faa-tada', '#', 1, 2),
(3, 'Data Pembayaran', 2, 'menu-icon fa fa-dollar faa-tada', 'Admin/Payment', 1, 1),
(4, 'Kategori', 2, 'menu-icon fa fa-sitemap faa-tada', 'Admin/Category', 1, 2),
(5, 'Produk', 2, 'menu-icon fa fa-gift faa-tada', 'Admin/Product', 1, 3);
...
(2, 'BCA', 'Khozin', '878787989787', 'bca.png', 1, '2018-06-01 10:53:48', 1, '2018-06-01 18:07:18', 1),
